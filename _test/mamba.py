...
class Pyramidmamba(nn.Module):
    def __init__(self, inputdim=512, hiddendim=128):
        ...
        # -----全局信息建模-----
        self.fssm1 = drqssm(d_model=hiddendim, d_state=16, d_conv=4, ssm_ratio=2)
        self.fssm2 = drqssm(d_model=hiddendim, d_state=16, d_conv=4, ssm_ratio=2)
        self.fssm3 = drqssm(d_model=hiddendim, d_state=16, d_conv=4, ssm_ratio=2)
