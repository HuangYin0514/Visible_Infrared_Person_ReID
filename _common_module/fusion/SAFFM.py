...
https://web.archive.org/web/20231029001212id_/https://dl.acm.org/doi/pdf/10.1145/3581783.3613814
"""
...
class SAFFM(nn.Module):
    def __init__(self, channel=64):
        ...
        self.spaCnnAtt = SpatialCNNAtt(in_channels=channel, SK_size=3)
    ...
    def forward(self, x, y):
        f = self.chaAtt(x) * self.spaCnnAtt(y)  # gate
