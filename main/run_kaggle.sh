...
python main.py --config_file "config/method.yml" TASK.NOTES=V108 TASK.NAME=B_C_IP OPTIMIZER.TOTAL_TRAIN_EPOCH=61 MODEL.MODAL_INTERACTION_FLAG=False MODEL.MODAL_CALIBRATION_FLAG=True MODEL.MODAL_PROPAGATION_FALG=True
