...
python main.py --config_file "config/method.yml" TASK.NAME=Baseline TASK.NOTES=V029  MODEL.MODULE=Lucky MODEL.BACKBONE_TYPE=resnet50 OPTIMIZER.TOTAL_TRAIN_EPOCH=55
