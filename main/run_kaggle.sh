...
python main.py --config_file "config/method.yml" TASK.NAME=Baseline TASK.NOTES=V026  MODEL.MODULE=Lucky MODEL.BACKBONE_TYPE=resnet50 MODEL.TOTAL_TRAIN_EPOCH=55
