...
# --------------- SYSU_MM01 --------------------------------
python main.py --config_file "config/method.yml" TASK.NOTES=V240 TASK.NAME=B_I_C_P OPTIMIZER.TOTAL_TRAIN_EPOCH=61 MODEL.NON_LOCAL_FLAG=True MODEL.GM_PARA=3.0
