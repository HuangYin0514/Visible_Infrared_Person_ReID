...
python main.py --config_file "config/method.yml" TASK.NOTES=V132 TASK.NAME=B_I_IP OPTIMIZER.TOTAL_TRAIN_EPOCH=61 MODEL.MODAL_INTERACTION_FLAG=True MODEL.MODAL_CALIBRATION_FLAG=False MODEL.MODAL_PROPAGATION_FALG=True
